(() => {
        ...
        <article class="producto" data-id="${escaparHTML(datos.id)}">
          ...
          <div class="product-body">
            ...
            <div class="product-actions">
              ...
              <button type="button" class="btn-carrito" data-action="agregar" data-id="${escaparHTML(datos.id)}">Agregar</button>
    ...
    contenedor.querySelectorAll(".producto").forEach(card => {
      card.addEventListener("click", event => {
        ...
        if (accion?.dataset.action === "agregar") {
          ...
          agregarAlCarritoPorId(productId);
          return;
        }
  ...
  function abrirModalProducto(producto) {
      ...
      <div class="detalle-grid">
        ...
        <div class="detalle-info">
          ...
          <div class="detalle-acciones">
            <button type="button" data-modal-agregar="${escaparHTML(datos.id)}">Agregar a cotización</button>
            <a href="https://wa.me/${WHATSAPP}?text=${mensajeWhatsApp}" target="_blank" rel="noopener">Cotizar por WhatsApp</a>
          </div>
        </div>
      </div>
    `;
    ...
    contenido.querySelector("[data-modal-agregar]")?.addEventListener("click", () => {
      agregarAlCarritoPorId(datos.id);
    });
  ...
  function crearCarrito() {
    ...
    wrapper.innerHTML = `
      ...
      <aside id="panelCarrito" class="panel-carrito" aria-label="Carrito de cotización">
        ...
        <div class="carrito-footer">
          <button type="button" class="enviar-cotizacion" id="enviarCotizacionBtn">
    ...
    id("enviarCotizacionBtn")?.addEventListener("click", enviarCarritoWhatsApp);
