(() => {
        ...
        <article class="producto" data-id="${escaparHTML(datos.id)}">
          ...
          <div class="product-body">
            ...
            <div class="product-actions">
              ...
              <button type="button" class="btn-carrito" data-action="agregar" data-id="${escaparHTML(datos.id)}">Carrito</button>
  ...
  function abrirModalProducto(producto) {
    ...
    const mensajeWhatsApp = encodeURIComponent(
      `Hola, quiero revisar esta pieza:\n\n` +
      `${titulo}\n` +
      `${subtitulo}\n` +
      `ID: ${datos.id || "N/C"}\n` +
  ...
  function enviarCarritoWhatsApp() {
    ...
    const mensaje = encodeURIComponent(
      `Hola, quiero revisar este carrito de autopartes:\n\n` +
      `${lista}\n\n` +
